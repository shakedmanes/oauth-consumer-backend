...
function generateCertificates(target) {  
  ...
  shell.exec(`C:\\"Program Files"\\Git\\mingw64\\bin\\openssl.exe req -new -key privatekey.pem -out certrequest.csr -days 1024 -nodes -subj "/C=US/ST=New York/L=New York/O=Bla Bla/OU=alB alB/CN=oauth-consumer"`);
